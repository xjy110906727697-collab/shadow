...
export function VideoPlayer({ videoUrl, onTimeUpdate }: VideoPlayerProps) {
  ...
  return (
    <div>
      ...
      <div className="bg-white border border-gray-200 rounded-b-lg px-4 py-3 space-y-3">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3 md:gap-4">
            <button onClick={togglePlay} className="text-gray-700 hover:text-blue-600 transition-colors p-1">
              {isPlaying ? (
          ...
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <button onClick={handleFullscreen} className="text-gray-400 hover:text-gray-600 transition-colors p-1">
