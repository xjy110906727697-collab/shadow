    ...
    while (true) {
      ...
      const overlaps = usedRanges.some(
        (r) =>
          ...
          (idx + w.word.length > r.start && idx + w.word.length <= r.end),
      );
      if (!overlaps) {
  ...
  return (
    <div className="bg-[#faf8f6] dark:bg-slate-800 rounded-xl shadow-sm border border-gray-100 dark:border-slate-700 flex flex-col h-full overflow-hidden">
      ...
      {isWordCards ? (
        ...
        <div ref={containerRef} className="overflow-y-auto flex-1 p-2 pt-0">
              ...
              return (
                ...
                >
                  {isActive ? (
                    ...
                    <div className="text-[11px] text-gray-400 dark:text-slate-500 font-mono mb-1">
                  ...
                  {mode === "盲听" ? (
                    <>
                      {blindRevealed.has(entry.id) ? (
                        <>
                          <div
                            className={`text-base font-extrabold leading-relaxed tracking-wider mb-1 ${isActive ? "text-gray-900 dark:text-slate-100" : "text-gray-800 dark:text-slate-200"}`}
                          ...
                          <div
                            className={`text-sm leading-relaxed ${isActive ? "text-gray-700 dark:text-slate-300" : "text-gray-600 dark:text-slate-400"}`}
                          >
                            {entry.zh}
                          </div>
                        </>
                    ...
                    <div
                      className={`text-lg font-bold leading-relaxed tracking-wider ${isActive ? "text-gray-900 dark:text-slate-100" : "text-gray-800 dark:text-slate-200"}`}
                      style={{ wordSpacing: "0.5em" }}
                    >
                      <HighlightedText
                        text={entry.ko}
                    ...
                    <>
                      <div
                        className={`text-lg font-extrabold leading-relaxed tracking-wider mb-0.5 ${isActive ? "text-gray-900 dark:text-slate-100" : "text-gray-800 dark:text-slate-200"}`}
                        style={{ wordSpacing: "0.5em" }}
                      >
                        <HighlightedText
                          text={entry.ko}
