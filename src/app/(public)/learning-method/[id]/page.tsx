    ...
    return (
      <div className="w-full px-4 md:px-6 py-4 pb-20 md:pb-4">
        <div className="max-w-3xl mx-auto text-center py-16">
          ...
          <h1 className="text-2xl font-bold mb-3 dark:text-slate-100">
            文章不存在
          </h1>
  ...
  return (
    <div className="w-full px-4 md:px-6 py-4 pb-20 md:pb-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-[#faf8f6] dark:bg-[#0a0a0e] border border-gray-200 dark:border-slate-700 rounded-lg p-4 md:p-8">
          <div className="flex items-center gap-2 mb-3">
            <span
              className={`text-xs font-medium px-2 py-0.5 rounded-full ${tagColors[article.tag] || "bg-gray-100 dark:bg-slate-700 text-gray-600 dark:text-slate-400"}`}
            >
              {article.tag}
            </span>
            {article.date && (
