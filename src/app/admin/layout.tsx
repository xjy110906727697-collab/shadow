      ...
      <div className="flex">
        <aside className="w-64 bg-white border-r border-slate-200/60 min-h-screen shadow-sm">
          ...
          <nav className="p-4 space-y-1">
            ...
            <Link href="/admin/word-cards" className="group flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 text-slate-600 hover:text-blue-600 transition-all">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
