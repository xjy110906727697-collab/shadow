...
export default function AdminInviteCodesPage() {
  ...
  return (
    <div className="p-6">
      ...
      <div className="bg-[#faf8f6] dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-slate-700 p-4 mb-6">
        <Space wrap>
          <Button
            type="primary"
            icon={<PlusOutlined />}
          ...
          <Button onClick={handleBatchGenerate} loading={generating}>
            批量生成 (10个)
          </Button>
      ...
      <div className="bg-[#faf8f6] dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-slate-700">
        <Table
          columns={columns}
          dataSource={codes}
          rowKey="id"
